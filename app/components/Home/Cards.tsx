    ...
    <div className="flex flex-wrap justify-center gap-8 py-10">
      {cardData.map((card, index) => (
        <div
          ...
          style={{
            boxShadow: "0 1px 5px rgba(99,102,241,0.4)",
          }}
        >
          {/* Glow Effect */}
           <div className="absolute  bg-[rgba(99,102,241,0.4)]/20 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div> 
          ...
          <div className="bg-[rgba(99,102,241,0.4)] w-36 h-36 -bottom-16 -left-10 overflow-hidden blur-3xl rounded-full absolute z-10 shadow-[0_0_15px_5px_rgba(255,193,69,0.8)]"></div>
